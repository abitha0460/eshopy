				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<a href="myaccount.php" data-target="#exampleModal" class="text-white">
							<i class="fas fa-sign-out-alt mr-2"></i>My Account</a>
								
						</li>
						<li class="text-center border-right text-white">
							<a href="myorder.php" data-target="#exampleModal" class="text-white">
							<i class="fas fa-sign-out-alt mr-2"></i>My Order</a>
						...
						<li class="text-center text-white">
							<a href="userlogout.php" data-toggle="modal" data-target="#exampleModal" class="text-white">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="userlogin.php" method="post" enctype="multipart/form_data">
	...
	<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="useregister.php" method="post" enctype="multipart/form_data">
						<div class="form-group">
						...
						<div class="form-group">
    <label class="col-form-label">Countries</label><br>
...
<div class="form-group">
    <label class="col-form-label" for="states">States</label><br>
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">New Brand Products</h3>
							<div class="row">
								<?php
								require("connection.php");
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="<?php echo "admin/productimages/".$rows["Image"];?>"width="120px" height="200">
										...
										<div class="item-info-product text-center border-top mt-4">
											<h4 class="pt-1">
												<a href="single.html"><?php echo $rows["ProductName"];?></a>
											</h4>
											<div class="info-product-price my-2">
												<span class="item_price"><?php echo $rows["Price"];?></span>
												<del></del>
											</div>
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="buynow.php?var=<?php echo $rows["Productid"];?>"method="post">
													<fieldset>
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 123 Abitha, India.</li>
							<li class="mb-3">
							...
							<li class="mb-3">
								...
								<a href="mailto:example@mail.com"> admin7@gmail.com</a>
							</li>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© 2024 E-Shopy. All rights reserved | Design by
				<a href="http://w3layouts.com"> Abitha.</a>
			</p>
		</div>
	</div>
	<!-- //copyright -->
